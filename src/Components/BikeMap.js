...
class BikeMap extends Component {
    ...
    render() {
      ...
      if (this.props.bikeData && this.props.bikeData !== null){

        // Map Popup Markers
        markers = this.props.bikeData.map((marker, index) => {

          // Convert to normal time configuration
          var date = new Date(marker.properties.occurred_at * 1000);
        ...
        return (
          ...
          <Map className="map" center={searchPosition} zoom={this.state.zoom}>
